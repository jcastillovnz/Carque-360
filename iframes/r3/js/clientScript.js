...
document.getElementById("plan-technique").style.backgroundImage = "url("+level1+"2D.jpg)";
document.getElementById("plan-axo").style.backgroundImage = "url("+level1+"3D.jpg)";
